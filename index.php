...
<link href="styles/bootstrap.min.css" rel="stylesheet">
  ...
  <!-- Cover -->
  <main>
    <div class="hero" style="text-align: center;padding-bottom:100px">
    <h1>Welcome to CVMOVTECH!</h1>
      <a href="shop.php" class="btn btn-success" style="width: 200px;height:50px;padding-top:13px">View all products
</a>
    </div>
    <!-- Main -->
    <div class="wrapper">
...
<div class="footer-nav">
  <div class="container clearfix">
    ...
    <div class="footer-nav__col footer-nav__col--contacts">
      ...
      Head Office: cvmovtech.<br>
      180-182 Regent Street, London.
    </address>
      <div class="phone">
        Telephone:
        <a class="phone__number" href="tel:0123456789">03172746242</a>
      </div>
      <div class="email">
        Email:
        <a href="mailto:support@yourwebsite.com" class="email__addr">support@cvmovtech.com</a>
      </div>
    </div>
...
<div class="banners">
  <div class="container clearfix">
    ...
    <div class="banner-award">
      <span>Award winner</span><br> Quality awards 2021
    </div>
